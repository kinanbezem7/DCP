...
class ScraperTestCase(unittest.TestCase, Scraper):
    ...
    def test_Scraper(self):
        ...
        expected_value = []
        price_list, name_list, isbn_list, id_list, img_list = self.get_data(link_list=['https://www.waterstones.com/book/matrix/lauren-groff/2928377100513', 'https://www.waterstones.com/book/lightseekers/femi-kayode/9781526657718'])
